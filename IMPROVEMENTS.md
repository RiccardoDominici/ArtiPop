...
| 2026-07-31 10:29 UTC | BUILD | test | m2-rotte-e-orchestrazione-sotto-test | backend/vitest.config.js, backend/tests/helpers/fakeEnv.js, backend/tests/integration/router-auth.test.js, backend/tests/integration/router-errori.test.js, backend/tests/integration/orchestrazione.test.js, CHANGELOG.md, ROADMAP.md | fable | FALLITO(EXEC) | auto/20260731-101814 | - |
