...
| 2026-07-31 10:15 UTC | BUILD | test | m2-integrazione-completa-router-e-orchestrazione | backend/tests/helpers/fakeEnv.js, backend/tests/integration/router-auth.test.js, backend/tests/integration/router-errori.test.js, backend/tests/integration/orchestrazione.test.js, backend/vitest.config.js, ROADMAP.md, CHANGELOG.md | fable | FALLITO(EXEC) | auto/20260731-100354 | - |
